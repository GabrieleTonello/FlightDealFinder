...
- [ ] 1. Set up project structure, Smithy models, and code generation
  - [ ] 1.1 Initialize Gradle project under `service/` with Java 25, JUnit 5, jqwik, and Smithy codegen dependencies in `build.gradle`
  ...
  - [ ] 1.2 Create Smithy model files under `smithy/model/`
