...
/**
 * Property 2: For any valid FlightDeal, the fields (destination, price, departureDate, returnDate,
 * airline) are all non-null after extraction.
 *
 * <p>Validates: Requirements 2.2, 4.2
 */
