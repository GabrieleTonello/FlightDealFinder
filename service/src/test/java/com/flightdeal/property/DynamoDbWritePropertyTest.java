...
/**
 * Property 4: For any FlightDeal and timestamp, the PriceRecordEntity passed to the DAO has correct
 * partition key (destination), sort key (timestamp), and all required fields.
 *
...
class DynamoDbWritePropertyTest {
  ...
  Arbitrary<String> validDestination() {
    return Arbitraries.of(
        "Paris", "Tokyo", "London", "Berlin", "Sydney", "Rome", "Madrid", "Dubai");
  }
