...
/**
 * Property 3: For any set of destinations where a subset fail, the handler still returns deals for
...
class ErrorIsolationPropertyTest {
  ...
  @Property(tries = 100)
  void failedDestinationsDoNotBlockSuccessful(@ForAll("destinationSets") DestinationSets sets)
      throws Exception {
                        ...
                        failCount -> {
                          List<String> successful =
                              IntStream.rangeClosed(1, successCount)
                                  .mapToObj(i -> "SuccessDest" + i)
                                  .collect(Collectors.toList());
                          List<String> failing =
                              IntStream.rangeClosed(1, failCount)
                                  .mapToObj(i -> "FailDest" + i)
                                  .collect(Collectors.toList());
