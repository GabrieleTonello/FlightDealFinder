...
/**
 * Property 13: For any count values, the emitted CloudWatch metric has the correct name, value, and
 * unit.
 *
...
class MetricsAccuracyPropertyTest {
  ...
  void emittedMetricsMatchActualCounts(@ForAll("metricInput") MetricInput input) {
    ...
    StandardUnit expectedUnit =
        input.metricType.equals("ExecutionDuration")
