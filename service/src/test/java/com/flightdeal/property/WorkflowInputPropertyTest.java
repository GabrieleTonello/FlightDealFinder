...
/**
 * Property 7: For any valid DealBatchMessage JSON, the Step Functions StartExecutionRequest input
...
class WorkflowInputPropertyTest {
  ...
  private static final String STATE_MACHINE_ARN =
      "arn:aws:states:us-east-1:123456789:stateMachine:TestWorkflow";
  private final ObjectMapper objectMapper = new ObjectMapper();

  @Property(tries = 100)
  void workflowInputMatchesDealBatchMessage(@ForAll("dealBatchJson") String dealBatchJson)
      throws Exception {
