...
class FlightApiClientTest {
  ...
  void setUp() {
    ...
    flightApiClient =
        new FlightApiClient(
            httpClient, "https://api.example.com", "test-key", Duration.ofSeconds(10));
  }
  ...
  void searchDeals_throwsOnHttpError() throws Exception {
    ...
    FlightApiException ex =
        assertThrows(FlightApiException.class, () -> flightApiClient.searchDeals("London"));
  ...
  void searchDeals_throwsOnTimeout() throws Exception {
    ...
    FlightApiException ex =
        assertThrows(FlightApiException.class, () -> flightApiClient.searchDeals("Berlin"));
  ...
  void searchDeals_throwsOnIOException() throws Exception {
    ...
    FlightApiException ex =
        assertThrows(FlightApiException.class, () -> flightApiClient.searchDeals("Rome"));
  ...
  void searchDeals_throwsOnMalformedJson() throws Exception {
    ...
    FlightApiException ex =
        assertThrows(FlightApiException.class, () -> flightApiClient.searchDeals("Madrid"));
