...
/** Unit tests for GoogleCalendarClient. Validates: Requirements 7.1, 17.1, 17.5 */
...
class GoogleCalendarClientTest {
  ...
  void getFreeBusyWindows_non200Status_throwsCalendarApiExceptionWithHttpError() throws Exception {
    ...
    CalendarApiException ex =
        assertThrows(
            CalendarApiException.class,
  ...
  @Test
  void getFreeBusyWindows_malformedJson_throwsCalendarApiExceptionWithParseError()
      throws Exception {
