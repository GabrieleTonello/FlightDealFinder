...
/** Unit tests for CalendarService. Validates: Requirements 7.1, 7.2, 7.3, 17.1, 17.5 */
...
class CalendarServiceTest {
  ...
  void lookupFreeWindows_successfulLookup_returnsFreeWindows() throws CalendarApiException {
    List<FlightDeal> deals = List.of(deal("Paris", "2025-07-01", "2025-07-10"));
  ...
  void lookupFreeWindows_singleDeal_usesItsDatesAsRange() throws CalendarApiException {
    List<FlightDeal> deals = List.of(deal("Berlin", "2025-08-05", "2025-08-12"));
  ...
  void lookupFreeWindows_calendarApiException_wrappedAsRuntimeException()
    ...
    RuntimeException thrown =
        assertThrows(RuntimeException.class, () -> calendarService.lookupFreeWindows(deals));
  ...
  @Test
  void lookupFreeWindows_calendarApiTimeout_wrappedAsRuntimeException()
      throws CalendarApiException {
    List<FlightDeal> deals = List.of(deal("Tokyo", "2025-09-01", "2025-09-10"));

    CalendarApiException timeoutException =
        new CalendarApiException("Request timed out", "TIMEOUT");
