...
/**
 * Unit tests for FlightMatcher (pure logic, no mocks needed).
...
class FlightMatcherTest {
    ...
    void matchDeals_dealDepartureBeforeWindowStart_rejected() {
        List<FlightDeal> deals = List.of(
                deal("Tokyo", "499.99", "2025-06-28", "2025-07-10")
        );
        List<TimeWindow> windows = List.of(
                window("2025-07-01", "2025-07-15")
        );
    ...
    void matchDeals_dealReturnAfterWindowEnd_rejected() {
        List<FlightDeal> deals = List.of(
                deal("London", "350.00", "2025-07-05", "2025-07-20")
        );
        List<TimeWindow> windows = List.of(
                window("2025-07-01", "2025-07-15")
        );
    ...
    void matchDeals_dealCompletelyOutsideWindow_rejected() {
        List<FlightDeal> deals = List.of(
                deal("Berlin", "199.99", "2025-08-01", "2025-08-10")
        );
        List<TimeWindow> windows = List.of(
                window("2025-07-01", "2025-07-15")
        );
    ...
    void matchDeals_exactBoundaryMatch_dealMatchesWindow() {
        List<FlightDeal> deals = List.of(
                deal("Rome", "249.99", "2025-07-01", "2025-07-15")
        );
        List<TimeWindow> windows = List.of(
                window("2025-07-01", "2025-07-15")
        );
