 ...
 * Validates: Requirements 9.1, 9.2, 9.3, 17.1, 17.5
 */
...
class NotificationServiceTest {
    ...
    void sendDealNotification_sesThrowsException_wrappedAsRuntimeException() {
        List<FlightDeal> deals = List.of(
                deal("Berlin", "199.99", "2025-09-01", "2025-09-10", "Lufthansa")
        );
    ...
    void sendDealNotification_singleDeal_subjectLineSingular() {
        List<FlightDeal> deals = List.of(
                deal("Rome", "350.00", "2025-10-01", "2025-10-08", "Alitalia")
        );
    ...
    void formatEmailBody_containsAllFieldsForEachDeal() {
        List<FlightDeal> deals = List.of(
                deal("Sydney", "899.00", "2025-12-20", "2025-12-30", "Qantas")
        );
    ...
    void sendDealNotification_usesCorrectSenderAndRecipient() {
        List<FlightDeal> deals = List.of(
                deal("Madrid", "275.00", "2025-06-15", "2025-06-22", "Iberia")
        );
